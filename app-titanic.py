...
#titanic_data, llama solamente la columna de embark_town .Tiene que agregar el unique por que osino trae todos los datos de la BD.
st.write("Selected Embark Town:", selected_town)

st.write(titanic_data.query(f"""embark_town==@selected_town"""))

st.markdown("___") 
#markdown es un separador.
