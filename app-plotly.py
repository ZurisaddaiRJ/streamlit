...
st.plotly_chart(fig_hours_gender) #IMPRIME
...
st.plotly_chart(fig_age) #IMPRIME GRAFICA
...
st.plotly_chart(fig_distribution_perf) #IMPRIME GRAFICA
...
st.plotly_chart(fig_perf_work) #IMPRIME GRAFICA
